...
- [x] Settings page (Invoicing > Configuration > Settings) loads without error
- [x] ECPay settings section displays correctly
- [x] All ECPay configuration options are accessible
- [x] No KeyError or AttributeError in server logs
- [ ] Works both when MRP is installed and not installed (only tested without MRP)
...
- [x] None - this is a blocking task that must be done first
...
- [x] If PASS: Mark task complete, update epic status
...
- [x] Settings page loads without KeyError
- [x] ECPay settings accessible and functional
- [x] Server logs show no related errors
- [x] Tested on live instance with Playwright
